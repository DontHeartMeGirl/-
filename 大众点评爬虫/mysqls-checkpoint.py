...
#连接MYSQL数据库
db = pymysql.connect(host="localhost", user="root", password="Cwh2432211491", database="testdb") #这里我修改了代码，源码代码为：db = pymysql.connect("localhost","root","","TESTDB" )
cursor = db.cursor() #源代码：cursor = db.cursor()
